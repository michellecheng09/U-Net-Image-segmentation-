...
of benign, malignant and normal patient scans. The purpose of this project was to explore the implmentation of the U-Net architecture to encode and decode image data to complete the segmentation. The goal is for the model to predict the mask for cancerours areas in a scan to aid healthcare professionals with early diagnosis and to improve treatement plans and patient care. 
